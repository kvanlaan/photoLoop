 ...
 * a title (possibly null), and a positive integer indicating the length of time
 * (duration) the image should be displayed in seconds.
 * 
 * <b>Do not modify anything in this file</b> (except possibly displayPicture()
...
public class Image {
	...
	/**
	 * Creates a new <tt>Image</tt> object with specified file name. The
	 * durations is initially 5; title is null string
	 * 
	 * @param fileName
	...
	/**
	 * Creates a new <tt>Image</tt> object with specified file name, durations
	 * and title.
	 * 
	 * @param fileName
	 *            the name of the file containing the image.
	 ...
	 * @param duration
	 *            the duration of the image's display.
	 */
	 ...
	 * 
	 * @param duration
	 *            the new duration (in hundreths of seconds) for this photo
	 */
	 ...
	 * <p>
	 * <tt><i>title</i> [<i>file_name</i> ,<i>duration</i>]</tt>
	 * </p>
	 * If title is null we use:
	 * <p>
	 * <tt><i>file_name</i> [<i>duration</i>]</tt>
	 * </p>
	 * 
